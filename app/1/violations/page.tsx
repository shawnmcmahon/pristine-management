    ...
    <>
      <section className="bg-[#0a1628] text-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h1 className="font-serif text-5xl font-bold">Violation Response Form</h1>
        ...
        {submitStatus === "success" ? (
          <div className="text-center py-16">
            ...
            <button
              ...
              className="bg-[#0a1628] text-white font-semibold px-8 py-3 hover:bg-[#c9a84c] hover:text-[#0a1628] transition-colors"
            >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs uppercase tracking-wider font-semibold text-[#0a1628] mb-1.5">
                  First Name *
                </label>
            ...
            <div>
              <label className="block text-xs uppercase tracking-wider font-semibold text-[#0a1628] mb-3">
                Resolution *
              </label>
            ...
            <div>
              ...
              <div
                className="border-2 border-dashed border-gray-300 hover:border-[#c9a84c] transition-colors p-6 text-center cursor-pointer"
              ...
              {files.length > 0 && (
                <ul className="mt-3 space-y-2">
                  {files.map((f, i) => (
                    <li key={i} className="flex items-center justify-between bg-[#f7f5f0] px-4 py-2 text-sm">
                      <span className="text-[#0a1628] truncate">{f.name}</span>
                      <button
                        type="button"
