    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
        <div className="grid md:grid-cols-3 gap-12">
          {/* Contact Info */}
          <div>
            <h2 className="font-serif text-2xl font-bold text-[#084870] mb-6">
              Reach Our Team
            </h2>
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-[#084870] flex items-center justify-center shrink-0">
                  <Phone size={16} className="text-[#1880A8]" />
                </div>
                <div>
                  <p className="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-1">Phone</p>
                  <a href={`tel:${siteConfig.phone}`} className="text-[#084870] hover:text-[#1880A8] transition-colors">
                    {siteConfig.phone}
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-[#084870] flex items-center justify-center shrink-0">
                  <Mail size={16} className="text-[#1880A8]" />
                </div>
                <div>
                  <p className="text-xs uppercase tracking-wider text-gray-500 font-semibold mb-1">Email</p>
                  <a href={`mailto:${siteConfig.email}`} className="text-[#084870] hover:text-[#1880A8] transition-colors break-all">
                    {siteConfig.email}
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 bg-[#084870] flex items-center justify-center shrink-0">
                  <MapPin size={16} className="text-[#1880A8]" />
                </div>
                <div>
            ...
            <div className="mt-10 bg-[#eaf3f5] border-l-4 border-[#1880A8] p-5">
              <p className="text-xs uppercase tracking-wider text-[#1880A8] font-semibold mb-2">Response Time</p>
          ...
          <div className="md:col-span-2">
            {submitStatus === "success" ? (
              <div className="text-center py-16">
                ...
                <h3 className="font-serif text-2xl font-bold text-[#084870] mb-3">Message Sent</h3>
                <p className="text-gray-600 mb-8">{statusMessage}</p>
                <button onClick={() => setSubmitStatus("idle")} className="w-full sm:w-auto bg-[#084870] text-white font-semibold px-8 py-3 hover:bg-[#1880A8] hover:text-[#084870] transition-colors">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs uppercase tracking-wider font-semibold text-[#084870] mb-1.5">First Name *</label>
                  ...
                  <div>
                    <label className="block text-xs uppercase tracking-wider font-semibold text-[#084870] mb-1.5">Last Name *</label>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs uppercase tracking-wider font-semibold text-[#084870] mb-1.5">Email *</label>
                ...
                <div>
                  <label className="block text-xs uppercase tracking-wider font-semibold text-[#084870] mb-1.5">Subject *</label>
                ...
                <div>
                  <label className="block text-xs uppercase tracking-wider font-semibold text-[#084870] mb-1.5">Message *</label>
